//! Asynchronous logging utility for YapBot applications
//!
//! This module provides a background-thread logger, log file rotation, and macro-based logging for YapBot applications.
...
pub fn log_and_print(msg: &str) {
    ...
    let full_msg = format!("[YapBot] {} {}", timestamp, msg);
